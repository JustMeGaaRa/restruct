...
export const ThemesContext = createContext<{
    ...
    setStyles: Dispatch<SetStateAction<Pick<ITheme, "elements" | "relationships"> | undefined>>;
...
export const ThemeProvider: FC<PropsWithChildren<{
    ...
    theme: originalTheme
        ...
        const [theme, setTheme] = useState<ITheme | undefined>(originalTheme);
        const [styles, setStyles] = useState<Pick<ITheme, "elements" | "relationships"> | undefined>();
...
export const useThemes = () => {
    ...
    const applyStyles = useCallback((styles: Pick<ITheme, "elements" | "relationships">) => {
        setStyles(styles);
    }, [setStyles]);

    const applyThemes = useCallback((themes: Array<ITheme>) => {
        setThemes(themes);
    }, [setThemes]);
